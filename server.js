...
var port		= process.env.PORT || 8080; // set the port rof our app
var User		= require('./app/models/user'); // calling the user.js model

// connect to our database (hosted on mongolab)
mongoose.connect('mongodb://dev1410:Monalisa?123@ds059682.mongolab.com:59682/node-api');
		...
		jwt.verify(token, superSecret, function(err, decoded){
			if (err){
				return res.status(403).send({
					success: false,
					message: 'Failde to authenticate token.'
				});
			} else {
